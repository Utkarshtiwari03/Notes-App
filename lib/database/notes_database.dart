...
class NotesDatabase {
  ...
  //check weather db is initialize or not;-
  //   if yes -> then it will return database instance
  //   if no -> then it will initialize databse
  ...
  Future<int> addNote(
      String title, String description, String date,int color
      ) async{
